...
class Soil_Profile extends Component{
    ...
    render() {
        ...
        const SoilLayersTitle = [   { title: "Name", field: "Name", type:"string", align:"center", editable: 'never'},
        ...
        return( 
            ...
            <Tab eventKey="Soil_Profile" title="Soil Profile" >
                <p></p>

                <Form validated onSubmit={this.saveAndContinue} validated>
                    <MaterialTable
                        title= "Soil Profile for Deconvolution"
                        columns={SoilLayersTitle}
